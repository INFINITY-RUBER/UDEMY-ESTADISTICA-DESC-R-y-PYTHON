...
data = mtcars
data.index = data["name"]# hace que la columna nombre sea el indice
print(data.head()) 
```

### Medidas de centralización
```{python}
print("MediaX Colm: ",data.mean()) # Media por columnas
print("MediaX fila: ",data.mean(axis = 1)) # Media por filas
print("mediana: ",data.median()) # modiana
print("Moda: ",mtcars.mode())# moda 
```
```{python}
import numpy as np
import pandas as pd
...
```{python}
plt.clf()
skewed_data = pd.DataFrame(np.random.exponential(size=100000)) # dato sesgado
